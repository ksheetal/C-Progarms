...
#include<stdio.h>
using namespace std;
void decrypt(char ctext[], int a ,  int a_inverse)
{
	...
	for(int i=0; i<strlen(ctext); i++)
	{
		...
		int temp=(a_inverse*(ctext[i]-65))%26;
		cout<<(char)(temp+97);
	}
}
void encrypt(char ptext[], int a, int a_inverse)
{
	char ctext[50];
